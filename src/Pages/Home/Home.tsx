...
const Home = () => {
  return (
    <>
        ...
        <div className='team-info'>
          ...
          <div className='team-info-btns'>
            <div className='btns-info-container'>
              <a className='btn-info btn' href='#know-more-page'>Узнать больше</a>
              <a className='btn-info btn' href='#games-page'>Игры</a>
              <a className='btn-info btn' href='#about-us-page'>О нас</a>
            </div>
      ...
      <div id='know-more-page'><Link to='know-more'/>
          ...
          <div className='know-container'>
            <div className='category'>
              ...
              <p className='category-text'>
                Коллекция слов в учебнике содержит 3600 
            ...
            <div className='category'>
              ...
              <p className='category-text'>
              Все слова которые ты изучил попадают в твой 
              личный словарь. Ты можешь отметить сложные для 
            ...
            <div className='category'>
              ...
              <p className='category-text'>
                В личном кабинете ты можешь следить за своим 
                прогрессом: сколько слов ты уже выучил всего и за каждый день.
              </p>
            </div>
          </div>
        </div>
